...
当前版本是 **test5 批量测试版，待实机验证**。以小米 Android 10
...
- `patches.sha256`：三个补丁各自的 SHA256。
- `venus-test-suite.sh`：安装并启动 test5 后，一次运行的实机测试脚本。
